...
// Define table names directly in the script to avoid import issues
const TABLES = {
...
async function createTables() {
  ...
  try {
    ...
    console.log(`✅ Created table: ${TABLES.WEBSITE_CONTENT}`)
    ...
    console.log(`✅ Created table: ${TABLES.BLOG_POSTS}`)
    ...
    console.log(`✅ Created table: ${TABLES.EVENTS}`)
    ...
    console.log(`✅ Created table: ${TABLES.GALLERIES}`)

    // Gallery images table
    await client.send(new CreateTableCommand({
      TableName: TABLES.GALLERY_IMAGES,
      KeySchema: [
        { AttributeName: 'PK', KeyType: 'HASH' },
        { AttributeName: 'SK', KeyType: 'RANGE' }
      ],
    ...
    console.log(`✅ Created table: ${TABLES.GALLERY_IMAGES}`)
    ...
    console.log(`✅ Created table: ${TABLES.CONTACTS}`)
    ...
    console.log(`✅ Created table: ${TABLES.REGISTRATIONS}`)
